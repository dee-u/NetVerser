...
namespace NetVerser.Windows
{
    ...
    public class WpfApplication : Application
    {
        ...
        /// </param>
        public WpfApplication(Boolean isSingleInstance) : base()
        {
        ...
        private Int32 RunSingleInstanceApplication(Window window)
        {
            ...
            else
            {
                ...
                //this will still call our main window hence I am using a flag not to initialize the form
                //InstanceManager.SetSecondInstance();
            }
